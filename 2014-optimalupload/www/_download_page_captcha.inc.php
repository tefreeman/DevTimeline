    ...
    <div class="pageSectionMainFull ui-corner-all">
        <div class="pageSectionMainInternal">
            ...
            <div class="captchaPageTable">
                <form method="POST" action="<?php echo safeOutputToScreen($file->getFullLongUrl()); ?>" autocomplete="off" id="form-join">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <div style="padding: 14px;">
                                        ...
                                        <div style="text-align:left;">
                                            <strong><?php echo safeOutputToScreen($file->originalFilename); ?> (<?php echo formatSize($file->fileSize); ?>)</strong>
                                        </div>
