    ...
    <div class="pageSectionMain ui-corner-all">
        <div class="pageSectionMainInternal">
            ...
            <div>
                ...
                <form class="international" method="post" action="<?php echo getCoreSitePath(); ?>/login.<?php echo SITE_CONFIG_PAGE_EXTENSION; ?>" id="form-join" AUTOCOMPLETE="off">
                    <ul>
                        ...
                        <li>
                            <div class="form-content">
								<a href="<?php echo getCoreSitePath(); ?>/forgot_password.<?php echo SITE_CONFIG_PAGE_EXTENSION; ?>"><?php echo t("forgot_password", "forgot password"); ?>?</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo getCoreSitePath(); ?>/register.<?php echo SITE_CONFIG_PAGE_EXTENSION; ?>"><?php echo t("register", "register"); ?></a>
                            </div>
                        </li>
                    </ul>
